...
function Galeria() {
  ...
  const imagens = [
    { src: "//oopsiinkedagain/assetsimage1.png", alt: "Imagem 1", category: "Estúdio" },
    { src: "//oopsiinkedagain/assetsimage2.png", alt: "Imagem 2", category: "Tattoos" },
    { src: "//oopsiinkedagain/assetsimage3.png", alt: "Imagem 3", category: "Estúdio" },
    { src: "//oopsiinkedagain/assetsimage3.png", alt: "Imagem 4", category: "Tattoos" },
    { src: "//oopsiinkedagain/assetsimage1.png", alt: "Imagem 5", category: "Estúdio" },
    { src: "//oopsiinkedagain/assetsimage2.png", alt: "Imagem 6", category: "Tattoos" },
  ];
    ...
    <>
      ...
      >
        <div
          ...
          style={{
            backgroundImage: "url(//oopsiinkedagain/assetsbackground2.png)",
